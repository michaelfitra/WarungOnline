                                ...
                                foreach ($_SESSION['cart'] as $index => $item) {
                                    ...
                                    <div class="row align-items-center mb-4 pb-3 border-bottom">
                                        <div class="col-3 col-md-2">
                                            <a href="<?= base_url('views/detail.php'); ?>"
                                        ...
                                        <div
                                            ...
                                            <div class="input-group input-group-sm quantity-control" style="width: 120px;">
                                                <button class="btn btn-outline-secondary minus-btn" type="button"><i
                                                        class="fas fa-minus"></i></button>
                                                <input type="number" class="form-control text-center qty-input"
                                                    name="qty[<?= htmlspecialchars($index); ?>]"
                                                    value="<?= htmlspecialchars($item_qty); ?>" min="1">
                                                <button class="btn btn-outline-secondary plus-btn" type="button"><i
                                                        class="fas fa-plus"></i></button>
                                            </div>
                                        </div>
                                        <div
                                            class="col-12 col-md-3 mt-3 mt-md-0 d-flex justify-content-md-end align-items-center">
                                            <h5 class="mb-0 fw-bold me-3">Rp <?= number_format($total_per_item, 0, ',', '.'); ?>
                                            </h5>
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                id="subtotal" value="Rp <?= number_format($total_harga, 0, ',', '.'); ?>" readonly
                                style="border-color: #ddd;">
                        </div>
                        <h4 class="mb-3">Total Pembayaran</h4>
                        <?php if ($isLoggedIn): ?>
                            <button class="btn btn-warning btn-lg w-100 py-3 fw-bold" data-bs-toggle="modal"
                                data-bs-target="#qrisModal">Checkout Sekarang</button>
                        <?php else: ?>
                            <!-- User belum login -->
                            <a href="<?= URL::base('views/auth/login.php'); ?>" class="btn btn-warning mt-4"
                                onclick="return confirm('Silakan login terlebih dahulu sebelum checkout.')">Login untuk
                                Checkout</a>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center">
                <div class="modal-header">
                    <h5 class="modal-title" id="qrisModalLabel">Scan QR untuk Bayar</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body">
                    <img src="<?= URL::assets('images/qris_dummy.webp'); ?>" alt="QRIS" class="img-fluid mb-3"
                        style="max-height: 300px;">
                    <p>Setelah klik "Saya Sudah Bayar", pesanan akan disimpan.</p>
                </div>
